...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocaml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocaml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ocaml**, part of the
...
- [ ] Changes are scoped to `ocaml` — do not include files for other languages
